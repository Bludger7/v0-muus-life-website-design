...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "about.p1": "muus.life, kişiye özel ve kurumsal ölçekli mobilya üretiminde, tasarımı mühendislik disipliniyle birleştiren çağdaş bir üretim markasıdır. Her projede estetik bütünlüğü, malzeme kalitesini ve uzun ömürlü kullanım deneyimini aynı standartta sunmayı hedefler.",
    ...
    "about.p3": "muus.life, tekil yaşam alanlarından kapsamlı kurumsal projelere kadar her işinde kalıcı memnuniyet, sürdürülebilir kalite ve zamansız tasarım anlayışını esas alır.",
    ...
    "services.corporate.desc": "muus.life, kurumsal firmalara özel mobilya üretiminde yüksek hassasiyet, seri üretim disiplini ve kurumsal kimliğe tam uyum sağlayan profesyonel çözümler sunar.",
    "services.custom": "Kişiye Özel Projeler",
    "services.custom.desc": "muus.life, yaşam alanlarını tamamen kişiye uygun hale getiren ölçüye özel mobilya üretiminde uzman bir yapıya sahiptir.",
  ...
  en: {
    ...
    "about.p1": "muus.life is a contemporary production brand that combines design with engineering discipline in custom and corporate-scale furniture production. In every project, we aim to deliver aesthetic integrity, material quality, and long-lasting user experience at the same standard.",
    ...
    "about.p3": "muus.life is based on lasting satisfaction, sustainable quality, and timeless design philosophy in all its work, from individual living spaces to comprehensive corporate projects.",
    ...
    "services.corporate.desc": "muus.life provides professional solutions with high precision, mass production discipline, and full compliance with corporate identity in custom furniture production for corporate companies.",
    "services.custom": "Custom Projects",
    "services.custom.desc": "muus.life has an expert structure in custom furniture production that completely customizes living spaces.",
